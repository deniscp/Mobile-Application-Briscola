...
public class Rules {
     ...
     */
    static final String[] sortedDeck={"1B", "2B", "3B", "4B", "5B", "6B", "7B", "JB", "HB", "KB", "1C", "2C", "3C", "4C", "5C", "6C", "7C", "JC", "HC", "KC", "1G", "2G", "3G", "4G", "5G", "6G", "7G", "JG", "HG", "KG", "1S", "2S", "3S", "4S", "5S", "6S", "7S", "JS", "HS", "KS"};

    /**
     *  Compute the total points of a given pile or deck in the type of an ArrayList<Card>
     *  @param playerPile the pile of a player (the cards he won)
     */
