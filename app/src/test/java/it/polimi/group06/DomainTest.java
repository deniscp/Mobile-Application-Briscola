...
public class DomainTest {
    ...
    public void gameTest() throws Exception {
        ...
        player0.add(new Card(1, Suit.Batons));
        player0.add(new Card(3, Suit.Batons));
        player0.add(new Card(5, Suit.Batons));
        player1.add(new Card(2, Suit.Batons));
        player1.add(new Card(4, Suit.Batons));
        player1.add(new Card(6, Suit.Batons));
